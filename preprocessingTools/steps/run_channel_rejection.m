...
if size(EEG.data,1) > 100 && strcmp(study,'7T')
...
else % less than 100 channels
    % Define cap layout for different studies
...
channels_removed{2} = setdiff({EEG.origchanlocs.labels},{EEG.chanlocs.labels}, 'stable');
