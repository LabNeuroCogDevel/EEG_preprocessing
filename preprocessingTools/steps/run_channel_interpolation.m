% need EEG.origchanlocs b/c this has channel locations and external channels removed- need for determining which channels have been rejected
...
if Flag128 == 1 % no clue what is going on here using from original pipeline
    ...
    n128name = {EEG.origchanlocs(need_128interp).labels};
    ...
    EEG_i = pop_interp(EEG, EEG.origchanlocs, 'spherical');
